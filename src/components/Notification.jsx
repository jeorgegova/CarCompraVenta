...
const Notification = ({ message, type = 'success', duration = 5000, onClose }) => {
  ...
  const getStyles = () => {
    const baseStyles = "fixed top-2 right-2 sm:top-4 sm:right-4 z-50 max-w-xs sm:max-w-sm w-full bg-white shadow-lg rounded-lg border transition-all duration-300";
      ...
      <div className="p-3 sm:p-4">
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-shrink-0 flex">
            <button
              onClick={handleClose}
              className="inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 rounded-md p-0.5 sm:p-1"
            >
